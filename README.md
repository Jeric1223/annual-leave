...
로그인 없이 계산기처럼 바로 사용할 수 있고, URL을 공유하면 같은 입력값을 그대로 전달할 수 있습니다.
...
한국 공휴일 데이터는 **공공데이터포털**의 API를 사용합니다. 키가 없어도 내장 폴백 데이터로 동작하지만, 정확한 공휴일 연동을 위해 발급을 권장합니다.
...
> 승인은 보통 즉시~수 분 내 자동 처리됩니다. 일일 1,000건 무료입니다.
> API 키 없이도 2025~2026년 주요 공휴일은 폴백 데이터로 자동 사용됩니다.
...
정적 파일만으로 동작하므로 별도 서버 없이 배포할 수 있습니다.
